...
<body>
        ...
        <section class="container-fluid">
            <section class="row featuresimage">
                ...
                <article class="col-md-12 col-sm-12">
                    <div class="p100">
                        <div class="intro">
                            <h1 class="">Fredley Food <br />and Beverages, Inc</h1>
                            <p> i dont know what to design here, help me guys. </p>
                            <button type="button" name="button" class="btn btn-primary ">See Restaurants</button>
                        </div>
                    </div>
                </article>
            </section>
                ...
                <article class="col-md-12 col-sm-12 p15020">
                    <div class="row">
                        <div class="col-md-2 col-sm-6">
                            <img src="img/vision.png" alt="" class="right img-responsive smallimg">
                        </div>
                        ...
                        <div class="col-md-2 col-sm-6">
                            <img src="img/mission.png" alt="" class="right center img-responsive smallimg">
                        </div>
            ...
            <section class="row featuresgray">
                <article class="col-md-12 col-sm-12 p15020">
                    <div class="introsub">
                        <h1 class="text-center">Restaurants</h1><br />
                    </div>
                    <div class="row">
                            ...
                            <figure class="snip1531">
                                ...
                                <figcaption>
                                    ...
                                    <div class="icons">
                                        ...
                                        <a><i class="fa fa-google-plus"></i></a></div>
                                </figcaption>
                            </figure>
                        </div>
                        <div class="col-md-4 col-sm-6">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-6">
                            <figure class="snip1402">
                                <img src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/331810/sample53.jpg" alt="sample53" />
                                <figcaption>
                                    <h3>Jonquil Gibson</h3>
    ...
    Read More <i class="ion-android-arrow-forward"></i></span>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-6">
                            <figure class="snip1121 red"><img src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/331810/sample18.jpg" alt="sample18" />
                                <figcaption>
                                    <div>
                    ...
                    <div class="row">
                        <div class="col-md-4 col-sm-6">
                            <figure class="snip0039">
                                <img src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/331810/sample8.jpg" alt="sample8" />
                                <figcaption>
                                    <h2 class="white">Scarlett <span>O’Hara</span></h2>
                                    <p>Weekends don't count unless you spend them doing something completely pointless.</p>
                                    <div class="icons">
                        ...
                        <div class="col-md-4 col-sm-6">
                            <figure class="snip0017">
                                ...
                                <figcaption>
                                    <h2>I don't need to <span>compromise</span> my principles</h2>
