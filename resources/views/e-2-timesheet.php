                                        ...
                                        <form class="" action="" method="post">
                                            <div class="p20">
                                                <div class="form-group label-floating" id="sandbox-container">
                                                    <label for="e-2-timesheet-fromdate" class="control-label">From</label>
                                                    <div class="input-group">
                                                        <input type="text" class="form-control " id="e-2-timesheet-fromdate" name="e-2-timesheet-fromdate" />
                                            ...
                                            <div class="p20">
                                                <div class="form-group label-floating" id="sandbox-container">
                                                    <label for="e-2-timesheet-todate" class="control-label">To</label>
                                                    <div class="input-group">
                                                        <input type="text" class="form-control " id="e-2-timesheet-todate" name="e-2-timesheet-todate" />
                                                        <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                                    </div>
                                                </div>
                                            </div>
