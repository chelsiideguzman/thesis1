                                        ...
                                        <form class="" action="" method="post">
                                            <div class="p20">
                                                <div class="form-group label-floating">
                                                    <label for="a-4-payroll-search-empid" class="control-label">Employee ID</label>
                                                    <input type="text" class="form-control" id="a-4-payroll-search-empid" name="a-4-payroll-search-empid" />
                                                </div>
                                            </div>
                                            <div class="p20">
                                                <div class="form-group label-floating">
                                                    <label for="a-4-payroll-search-name" class="control-label">Name</label>
                                                    <input type="text" class="form-control" id="a-4-payroll-search-name" name="a-4-payroll-search-name" />
                                                </div>
                                            </div>
                                            <div class="p20">
                                            ...
                                            <div class="p20">
                                                <div class="form-group label-floating" id="sandbox-container">
                                                    <label for="a-4-payroll-fromdate" class="control-label">From</label>
                                                    <div class="input-group">
                                                        <input type="text" class="form-control " id="a-4-payroll-fromdate" name="a-4-payroll-fromdate" />
                                            ...
                                            <div class="p20">
                                                <div class="form-group label-floating" id="sandbox-container">
                                                    <label for="a-4-payroll-todate" class="control-label">To</label>
                                                    <div class="input-group">
                                                        <input type="text" class="form-control " id="a-4-payroll-todate" name="a-4-payroll-todate" />
                                                        <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                                    </div>
                                                </div>
                                            </div>
                    ...
                    <div class="row">
                            <div class="col-md-12 col-sm-12">
                                <div class="pull-right">
                                    <button type="button" class="btn btn-primary btn-raised">Select All</button>
                                    <button type="button" class="btn btn-primary btn-raised">Export to Excel</button>
                                </div>
                            </div>
                    </div>
                    <div class="row">
