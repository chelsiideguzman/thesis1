                        ...
                        <form class="" action="" method="post">
                            <div class="col-md-12 col-sm-12">
                                <div class="form-group label-floating">
                                    <label for="m-2-workschedule-notes" class="control-label">Notes</label>
                                    <textarea id="m-2-workschedule-notes" class="form-control"></textarea>
                                </div>
                            </div>
                        </form>
                    </div>
                    <div class="row">
                        <div class="col-md-12 col-sm-12">
                            <div class="pull-right">
                                <button type="button" class="btn btn-success btn-raised">Approve</button>
